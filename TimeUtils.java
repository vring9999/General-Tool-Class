...
public class TimeUtils {
	...
	/**
	 * 获取n天之后的日期 n为负数为之前
	 * @Title: getNumDayAfter
	 * @Description: TODO
	 * @param day
	 * @return
	 */
	public static Date getNumDayAfter(int day) {
		return getNumDayAfter(new Date(), day);
	}
	public static Date getNumDayAfter(Date nowTime, int day) {
     ...
     * @return
     */
    public static long getTimeDistance(String end) {
